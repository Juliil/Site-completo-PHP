...
##                   Configurações                       ##
###########################################################
$server_name = 'L2Steel'; // Nome do servidor
$server_chronicle = 'Interlude'; // Crônica do servidor
$server_url = 'www.l2steel.com'; // Digite exatamente o URL onde se encontra este site (exemplo: www.l2server.com)
...
###########################################################
$admin_email = 'admin@l2steel.com'; // Endereço de e-mail que os jogadores podem utilizar para entrar em contato
$server_email = 'no-reply@l2steel.com'; // Seu endereço de e-mail utilizado para enviar e-mails automáticos (exemplo: nao-responda@seuservidor.com)
...
$facePage = 'https://www.facebook.com/Atualstudio/'; // Página no Facebook


###########################################################
##              Página de Doações Pública                ##
###########################################################
$coinName = 'Coin'; // Nome do item donate
...
$bannerDelay = 2; // De quantos em quantos segundos os banners na página inicial se revesam?
