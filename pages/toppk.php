<?php if(!$indexing || $dpage['toppkp'] != 1) { echo "<script>document.location.replace('./');</script>"; exit; } ?>
...
<div class='pddInner'>
	<?php echo $LANG[30503]."<br />".$LANG[30500]." <b>".date('d/m/Y', $updated)."</b> ".$LANG[30501]." <b>".date('H:i', $updated)."</b>."; ?><br /><br />
</div>
...
<table cellspacing="0" cellpadding="0" border="0" class='default'>
	...
	$countView = (!empty($countTopPK) ? intval($countTopPK) : 100);
